...
generated_power = 400000 # total power generated in kilo Watts
households = 100000 # number of simulated households#heaters = [1, 2, 3, 5, 7, 8] # power consumption in kilo Watts
...
def update_availability(actual_network_frequency): # randomly switch consumers on and off to maintain a balanced load on the system
    for house in range(households):        
        pseudo_random = 0
        for chance in range(consumptions[house]): # bigger the consumption the higher the chance to switch it off
